...
const  sql = {
    delete: 'DELETE FROM radcheck WHERE id = $1 RETURNING id',
    update: 'UPDATE radcheck SET username=${username}, attribute=${attribute}, op=${op}, value=${value} WHERE id=${id} RETURNING id',
    insert: 'INSERT INTO radcheck(username, attribute, op, value) VALUES (${username}, ${attribute}, ${op}, ${value}) RETURNING id',
    findById: 'SELECT * FROM radcheck WHERE id = $1',
    findByUserName: 'SELECT * FROM radcheck WHERE username = $1'
}
